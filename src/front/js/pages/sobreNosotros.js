  ...
  return (
    <>
      ...
      >
        ...
        <br />
        <p>
          <br> </br>La política de la <strong>RUTA 3B</strong> se basa en
          ofrecer locales con una <strong> BUENA CALIDAD </strong> , a la vez de
          un <strong> BUEN TRATO AL CLIENTE </strong> y un{" "}
          <strong> BUEN PRECIO </strong>. <br /> Por favor, si tu local no
          cumple con los requisitos de nuestra política le pedimos que no
          registre su local.{" "}
        </p>{" "}
      </div>{" "}
    </>
