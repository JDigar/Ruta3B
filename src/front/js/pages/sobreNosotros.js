  ...
  return (
    <>
      ...
      >
        ...
        <br />
        <p>
          Ey! Como nos alegra verte por aquí! <br /> <br></br>Si estás aquí es
          que eres miembro o estás pensando en ser miembro de la{" "}
          <strong>RUTA 3B</strong> , donde podrás exponer de forma simple y
          rapida tus servicios y promociones basados en nuestra politica 3B
          ...
          que cumplen con la política de la <strong>RUTA 3B</strong>.
        </p>
        <br />
        <br />
        <h2>
        ...
        <br />
        <p>
          <br></br>La política de la <strong>RUTA 3B</strong> se basa en ofrecer
          locales con una <strong>BUENA CALIDAD</strong> , a la vez de un{" "}
          <strong>BUEN TRATO AL CLIENTE</strong> y un{" "}
          <strong>BUEN PRECIO</strong>. <br /> Por favor, si tu local no cumple
          con los requisitos de nuestra política le pedimos que no registre su
          local.
        </p>
      </div>
    </>
